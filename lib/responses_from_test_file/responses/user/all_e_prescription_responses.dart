...
//
//     final allEPrescriptionResponse = allEPrescriptionResponseFromJson(jsonString);

import 'dart:convert';

AllEPrescriptionResponse allEPrescriptionResponseFromJson(String str) => AllEPrescriptionResponse.fromJson(json.decode(str));

String allEPrescriptionResponseToJson(AllEPrescriptionResponse data) => json.encode(data.toJson());

class AllEPrescriptionResponse {
  AllEPrescriptionResponse({
    required this.message,
    required this.allEPrescription,
  });

  String message;
  List<AllEPrescription> allEPrescription;

  factory AllEPrescriptionResponse.fromJson(Map<String, dynamic> json) => AllEPrescriptionResponse(
    message: json["message"],
    allEPrescription: List<AllEPrescription>.from(json["AllEPrescription"].map((x) => AllEPrescription.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "message": message,
    "AllEPrescription": List<dynamic>.from(allEPrescription.map((x) => x.toJson())),
  };
}

class AllEPrescription {
  AllEPrescription({
    required this.id,
  ...
  factory AllEPrescription.fromJson(Map<String, dynamic> json) => AllEPrescription(
    id: json["id"],
    userId: json["user_id"],
